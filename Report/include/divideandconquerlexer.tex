...
the tree. However in a sequence representations, constant time complexity is
...
the tree. Lets use the master method to put this in to numbers, $e = log_b a$
...
of needed update calls at every level of the tree is $1$, therefore $a = 1$.
The constant $b$ is still $2$. This will give $e = log_2 1 = 0$. Thus the update
function of the incremental algorithm will have a time complexity of
