...
To be incremental means that, whenever some part of the input data to the
algorithm changes the algorithm tries to save time by only recomputing the parts
that depend on this changed data
\cite{incrementalDef}. This is illustrated in \cref{fig:incUp}.
...
and end of the collection easy. In the following section fingertrees will be
