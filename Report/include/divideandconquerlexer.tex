...
in \cref{fig:concat} the only operation that is run recursivly is $nodes$, \cref{fig:nodesHelp}. $nodes$
...
which is simliar to the implementation without measures,
...
implemented the type of the elements will change, in the begining it is $a$ at
