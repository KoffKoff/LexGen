...
The defenition of the fingertrees can be described by comparing it to an already
...
Since all leafs in the 2-3 tree is at the same level, the left and right
...
character would be found somewhere in the code the lexer can't return a lexical
